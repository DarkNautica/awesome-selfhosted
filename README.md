...
- - [Relay](https://github.com/DarkNautica/Relay) - Open source, self-hostable WebSocket server. Pusher-compatible, single Go binary, no dependencies. Multi-app support, channel history, built-in dashboard. ([Demo](https://relaycloud.dev)) `MIT` `Go`
